...
with sess.as_default():
    ...
    for epoch in range(1, 5001):
        ...
        s, v = learner.update_next_state(state_vector, action_vector, reward_vector, nextstate_vector)
        print(s, v)

        learning_rate = 1.
        overfitted = False
        while True:
            l, d = learner.optimize_policy_batch(learning_rate, state_vector, action_vector, reward_vector)
