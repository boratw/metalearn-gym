...
from networks.morl_learner2 import MORLLearner
...
learner = MORLLearner(state_dim, action_dim, gamma=gamma, action_maximum=action_maximum, update_kl_div=1e-4)
...
with sess.as_default():
    ...
    for epoch in range(1, 10001):
        ...
        for i in range(action_variance):
            ...
            curreward_stochastic = np.add(curreward_stochastic, np.multiply(qvalue, survive_vector))
