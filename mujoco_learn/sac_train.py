...
with sess.as_default():
    ...
    for epoch in range(1, 50001):
        ...
        pl1 /= 8.
        sl1 /= 8.
        print("Epoch " + str(epoch) + " Learner 1 Mean Qvalue : " + str(qs1) + " Loss : " + str(ql1))
        print("Epoch " + str(epoch) + " Learner 1 Mean Value : " + str(vs1) + " Loss : " + str(vl1))
        print("Epoch " + str(epoch) + " Learner 1 Mean Policy : " + str(ps1) + " Loss : " + str(pl1))
        print("Epoch " + str(epoch) + " Learner 1 State Loss : " + str(sl1))
