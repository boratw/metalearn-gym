...
class AcrobotReachEnv(core.Env):
    ...
    **REFERENCE:**
    ...
    def step(self, a):
        ...
        reward = 1.01 - ((sin(ns[0]) + sin(ns[0] + ns[1]) - self.goal[0]) ** 2 + (cos(ns[0]) + cos(ns[0] + ns[1]) + self.goal[1]) ** 2)
        terminal = bool(reward > 1. and ns[2] < 0.1 and ns[3] < 0.1)
    ...
    def render(self, mode='human'):
        ...
        if self.viewer is None:
            ...
            self.goalpoint = rendering.make_circle(0.1)
        ...
        self.goaltrans.set_translation(self.goal[0], self.goal[1])
